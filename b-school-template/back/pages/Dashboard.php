...
$requeteCount = "select count(*) countS from Enseignant where id_annee='$id_annee'";

$requeteCountE = "select count(*) countE from ELEVE where id_annee='$id_annee'";
$requeteCountEM = "select count(*) countEM from ELEVE where SEXE_ELEVE='masculin' and id_annee='$id_annee'";
$requeteCountEF = "select count(*) countEF from ELEVE where SEXE_ELEVE='feminin' and id_annee='$id_annee'";


$resultatCount = $pdo->query($requeteCount);
$resultatCountE = $pdo->query($requeteCountE);
$resultatCountEM = $pdo->query($requeteCountEM);
$resultatCountEF = $pdo->query($requeteCountEF);

$tabCount = $resultatCount->fetch();
$nbrEnseignant = $tabCount['countS'];

$tabCountE = $resultatCountE->fetch();
$nbrEleve = $tabCountE['countE'];

$tabCountEM = $resultatCountEM->fetch();
$nbrEleveM = $tabCountEM['countEM'];

$tabCountEF = $resultatCountEF->fetch();
$nbrEleveF = $tabCountEF['countEF'];
?>
...
<div class="kt-widget17">
    <!-- <div class="kt-widget17__visual kt-widget17__visual--chart kt-portlet-fit--top kt-portlet-fit--sides"
        ...
        <div class="kt-widget17__chart" style="height:320px;">
            ...
            <canvas id="kt_chart_activities" width="787" height="216"
                style="display: block; width: 787px; height: 216px;" class="chartjs-render-monitor"></canvas>
        </div>
    </div> -->
    <div class="kt-widget17__stats">
        ...
        <div class="kt-widget17__items">
            ...
            <div class="kt-widget17__item">
                <span class="kt-widget17__icon text-warning">
                    ...
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <path
                            ...
                            id="Rectangle-102-Copy" fill="#000000"></path>
                    </g>
                    </svg>
                </span>
                <span class="kt-widget17__subtitle">
