...
<body
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                    <div class="kt-login__container">
                        ...
                        <div class="kt-login__signin">
                            ...
                            <form class="kt-form" method="POST" action="SeConnecter.php">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="login" type="text" autocomplete="off"
                                        placeholder="Login">
                                </div>
                                <div class="input-group">
                                ...
                                <div class="row kt-login__extra">
                                    ...
                                    <div class="col kt-align-right">
                                        <a href="login copy.php" class="kt-login__link">Mot de
                                            passe
                                            oublié ?</a>
                                    </div>
                                </div>
                                <div class="kt-login__actions">
                                    <button class="btn btn-brand btn-pill kt-login__btn-primary">Se connecter</button>
                                </div>
                            </form>
                        </div>
                        ...
                        $userp = rechercher_user_par_email_p($email);
                        $usere = rechercher_user_par_email_e($email);
                        $random_id = rand(time(), 10000000);

                        if ($userp != null) {
                            $id = $userp['ID_PARENT'];
                            $requete = $pdo->prepare("update PARENT set MOT_DE_PASSE_PARENT=$random_id where ID_PARENT=$id");
                            $requete->execute();
                            ...
                            $content = "Votre nouveau mot de passe est $random_id, veuillez le modifier à la prochine ouverture de session";
                            ...
                            $id = $usere['id_enseignant'];
                            $requete = $pdo->prepare("update ENSEIGNANT set MOT_DE_PASSE_enseignant=$random_id where id_enseignant=$id");
                            $requete->execute();
                        ...
                        <div class="kt-login__forgot">
                            <div class="kt-login__head">
                                <h3 class="kt-login__title">Mot de passe
                                    oublié ?</h3>
                                <div class="kt-login__desc">Entrer votre email pour reinitialiser votre mot de passe:
                                </div>
                            </div>
                            <form class="kt-form" method="post">
                                ...
                                <div class="kt-login__actions">
                                    <input type="submit" name="" id="" value="Confirmer"
                                        class="btn btn-brand btn-pill kt-login__btn-primary">
                                    <button
                                        class="btn btn-brand btn-pill kt-login__btn-primary">Confirmer</button>&nbsp;&nbsp;
                                    <button
                                        class="btback/pages/login.phpn btn-secondary btn-pill kt-login__btn-secondary">Annuler</button>
                                </div>
                            </form>
                            <br>
    ...
    <script src="../assets/vendors/custom/components/vendors/bootstrap-markdown/init.js" type="text/javascript">
    </script>
